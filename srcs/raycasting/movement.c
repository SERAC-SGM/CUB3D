...
void	move_player(t_data *data)
{
	if (data->move_fwd == 1)
	{
		if(data->mdata->map[(int)(data->player->posx + (data->player->dirx * MOVE_SPEED * 2))][(int)data->player->posy] == 0)
			data->player->posx += data->player->dirx * MOVE_SPEED;
		if(data->mdata->map[(int)data->player->posx][(int)(data->player->posy + (data->player->diry * MOVE_SPEED * 2))] == 0)
...
void	rotate_player(t_data *data)
{
	...
	{
		data->player->dirx = old_dirx * cos(ROTATE_SPEED / 2) - data->player->diry * sin(ROTATE_SPEED / 2);
		data->player->diry = old_dirx * sin(ROTATE_SPEED / 2) + data->player->diry * cos(ROTATE_SPEED / 2);
		data->player->planex = old_planex * cos(ROTATE_SPEED / 2) - data->player->planey * sin(ROTATE_SPEED / 2);
		data->player->planey = old_planex * sin(ROTATE_SPEED / 2) + data->player->planey * cos(ROTATE_SPEED / 2);
	}
